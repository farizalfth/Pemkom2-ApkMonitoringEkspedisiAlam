 ...
 * termasuk ekspor data canggih ke CSV dan PDF.
 */
public class MainDashboard extends JFrame {
    ...
    private JPanel createTopPanel() {
        ...
        lblTotal = new JLabel(); lblAktif = new JLabel(); lblKembali = new JLabel();
        lblTertunda = new JLabel(); lblDibatalkan = new JLabel();
    ...
    String[] columnNames = {"ID", "Nama Tim", "Tujuan", "Tanggal", "Status"};
    ...
    // --- PERBAIKAN DI SINI ---
    // Menggunakan nama kelas lengkap untuk menghindari ambiguitas dengan com.itextpdf.text.Font
    ...
    private JPanel createBottomPanel() {
        ...
        JButton btnEdit = new JButton("Ubah Data");
        JButton btnHapus = new JButton("Hapus Data");
        JButton btnDetail = new JButton("Lihat Detail");
        JButton btnExportCSV = new JButton("Ekspor ke CSV");
        JButton btnExportPDF = new JButton("Cetak Laporan PDF");
    ...
    public void loadDataAndStats() {
        ...
        lblAktif.setText("Aktif: " + stats[1]);
        lblKembali.setText("Kembali: " + stats[2]);
        lblTertunda.setText("Tertunda: " + stats[3]);
        lblDibatalkan.setText("Dibatalkan: " + stats[4]);
    }
    ...
    private void openDetailDialog() {
        ...
        if (selectedRow != -1) {
            ...
            showWarning("Pilih data untuk dilihat detailnya.");
        }
    }
    ...
    private void deleteEkspedisi() {
        ...
        if (selectedRow != -1) {
            ...
            int response = JOptionPane.showConfirmDialog(this, 
                "Anda yakin ingin menghapus ekspedisi '" + namaTim + "'?", 
    ...
    private void addDetailPdfRow(Document doc, String label, String value, Font labelFont, Font valueFont) throws DocumentException {
    ...
    private JSeparator createVerticalSeparator() { JSeparator sep = new JSeparator(SwingConstants.VERTICAL); sep.setPreferredSize(new Dimension(1, 20)); return sep; }
    private void switchLanguage(Locale locale) { I18n.setLocale(locale); this.dispose(); SwingUtilities.invokeLater(() -> new MainDashboard().setVisible(true)); }
}